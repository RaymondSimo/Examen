...
$pw = "z3vozuor0t984sxs";
$con=mysql_connect('am1shyeyqbxzy8gc.cbetxkdyhwsb.us-east-1.rds.amazonaws.com','x4zgv7cwfuaergf6','z3vozuor0t984sxs') or die ("Problemas al conectar server");
mysql_select_db($con,$db) or die("Problemas al conectar database");

$result = mysql_query("SELECT * FROM productos" ) ; 
if ($row = mysql_fetch_array($con,$result)){ 
